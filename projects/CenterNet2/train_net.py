...
def setup(args):
    ...
    register_coco_instances(cfg.DATASETS.TRAIN[0], {}, "./datasets/coco/train_text.json", "./datasets/coco/train")
    register_coco_instances(cfg.DATASETS.TEST[0], {}, "./datasets/coco/valid_text.json", "./datasets/coco/valid")
